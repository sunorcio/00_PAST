...
void cameraUpdate(void){
	...
	proj_glortho(-cameraframe*sqrt(2)/8.,cameraframe*sqrt(2)/8.,
					-cameraframe*sqrt(2)/8.,cameraframe*sqrt(2)/8.,
...
/* 	level[0+0*levelsize+0*levelsize*levelsize] = 1; */
	...
	glViewport(0,0,cameraframe,cameraframe);
...
void renderDraw(void){
	...
	glBlitFramebuffer(0,0,cameraframe,cameraframe,
