...
static void printm4(float m[4*4]){
	int i;
	SDL_Log("\n");
	for(i = 0;i<4;i++){
...
static void printm3(float m[3*3]){
	int i;
	SDL_Log("\n");
	for(i = 0;i<3;i++){
...
static void mat_cp_3(float src[3*3],float dest[3*3]){
...
static void mat_cp_3_4(float src[3*3],float dest[4*4]){
...
static void mat_mul_3(float a[3*3],float b[3*3],float dest[3*3]){
	float c[3*3] = {0};
